...
class Triple(Data):
    ...
    def __init__(self, X_train, y_train, X_test, y_test):
        ...
        self.train_sampler = BatchSampler(len(self.train_y[0]), shuffle=True)
    ...
    def train_next_batch(self, batch_size=None):
        ...
        return (
            ...
            (self.train_y[0][indices], self.train_y[1][indices], self.train_y[2]),
        )
...
class TripleCartesianProd(Data):
    ...
    def losses(self, targets, outputs, loss_fn, inputs, model, aux=None):
        #return loss_fn(targets, outputs, inputs) #revised
        return loss_fn(targets, outputs)
    ...
    def train_next_batch(self, batch_size=None):
        ...
        if not isinstance(batch_size, (tuple, list)):
            ...
            return (self.train_x[0][indices], self.train_x[1]), (self.train_y[0][indices], self.train_y[1][indices], self.train_y[2] ) #revised
        ...
        ), (self.train_y[0][indices_branch, indices_trunk], 
            self.train_y[1][indices_branch, indices_trunk], 
            self.train_y[2][indices_trunk]) #revised
